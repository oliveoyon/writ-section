...
<div class="container py-4">
    <h3 class="mb-2">{{ __('tracking.court.dispatch_title') }}</h3>
    <p class="text-muted mb-3">{{ __('tracking.court.dispatch_subtitle') }}</p>
    ...
    <form method="POST" action="{{ route('admin.tracking.court.dispatch.store') }}" class="card p-4">
        @csrf
        ...
        <button type="submit" class="btn btn-brand mt-3">{{ __('tracking.court.dispatch_submit') }}</button>
