...
@section('content')
    ...
    <div class="modal fade" id="assignPermissionsModal" tabindex="-1" aria-labelledby="assignPermissionsLabel"
        aria-hidden="true">
                                                ...
                                                @foreach ($groupPermissions as $perm)
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input permissionCheckbox" type="checkbox"
                                                            value="{{ $perm->id }}" data-name="{{ $perm->name }}"
                                                            id="perm-{{ $perm->id }}">
    ...
    <div class="lawyer-card p-3 shadow-sm">
        ...
        <small class="text-muted">Created: ${resp.role.created_at.split('T')[0]}</small>
                            ...
                            if (id) {
                                ...
                                document.getElementById('rolesContainer').insertAdjacentHTML(
                                    'beforeend', cardHtml);
                            }
                            modal.hide();
